# Using Nano Banana (Gemini 2.5 Flash Image) with JavaScript

This guide explains how to use Nano Banana (Gemini 2.5 Flash Image) in JavaScript with the Google GenAI JS/TS SDK.

**More resources:**

*   [Get an API key from Google AI Studio](https://aistudio.google.com/app/apikey).
*   [Nano Banana Gemini API docs](https://ai.google.dev/docs/gemini_api_overview)
